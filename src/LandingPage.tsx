    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mb-12">
        <Card className="shadow-md p-6 flex flex-col items-center text-center">
          ...
          <p className="text-gray-500 text-sm">Add your surplus products in minutes</p>
        </Card>
        <Card className="shadow-md p-6 flex flex-col items-center text-center">
          <Users className="h-8 w-8 text-purple-600 mb-3" />
          <h3 className="font-semibold text-gray-800 mb-1">Vendor Network</h3>
          <p className="text-gray-500 text-sm">Connect with verified vendors</p>
        </Card>
        <Card className="shadow-md p-6 flex flex-col items-center text-center">
          <TrendingUp className="h-8 w-8 text-purple-600 mb-3" />
          <h3 className="font-semibold text-gray-800 mb-1">Maximize Profit</h3>
          <p className="text-gray-500 text-sm">Turn surplus into revenue</p>
        </Card>
      </div>
      ...
      <div className="flex gap-4">
        ...
        <Button
          className="px-6 py-2 rounded-lg shadow border border-gray-300 text-gray-800 bg-white hover:bg-gray-100"
